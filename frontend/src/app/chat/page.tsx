                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {conv.tags?.includes("prioridade") && (
                                                <span className="px-1.5 py-0.5 bg-blue-100 text-blue-700 rounded text-[10px] font-bold uppercase tracking-wider flex items-center gap-1">
                                                    <Loader2 className="w-3 h-3 hidden" /> Urgente
                                                </span>
                                            )}
                                        </div>
                                    </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-green-600 flex items-center gap-2">
                                        ...
                                        {selectedConversation.tags?.includes("prioridade") && (
                                            <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded text-xs font-bold uppercase tracking-wider flex items-center gap-1">
                                                Urgente
                                            </span>
                                        )}
                                    </p>
